...
class VendingMachine:
    ...
    def restock(self, n):
        ...
        "*** YOUR CODE HERE ***"
        self.product_left += n
        return f'Current {self.product} stock: {self.product_left}'
    ...
    def vend(self):
        ...
        funds_left = self.balance - self.price
        if funds_left < 0:
            return f'Please add ${self.price - self.balance} more funds.'
        self.product_left -= 1
        self.balance = 0
        message = f'Here is your {self.product}'
        return message + f' and ${funds_left} change.' if funds_left != 0 else message + '.'
