...
def make_averaged(original_function, times_called=1000):
    ...
    # BEGIN PROBLEM 8
    "*** YOUR CODE HERE ***"
    def average_performing(*args):
        total, n = 0, 0
        while n < times_called:
            total += original_function(*args)
            n += 1
        return total / times_called
    return average_performing
    # END PROBLEM 8
...
def max_scoring_num_rolls(dice=six_sided, times_called=1000):
    ...
    val_max, pos_max = 0, 0
    while i <= 10:
        curr = averaged_dice(i, dice)
        if curr > val_max:
            pos_max, val_max = i, curr
        i += 1
    return pos_max
    # END PROBLEM 9
...
def boar_strategy(score, opponent_score, threshold=11, num_rolls=6):
    ...
    """
    # BEGIN PROBLEM 10
    b = boar_brawl(score, opponent_score)
    if b >= threshold:
        return 0
    else:
        return num_rolls
...
def final_strategy(score, opponent_score):
    ...
    *** YOUR DESCRIPTION HERE ***
    """
    # BEGIN PROBLEM 12
    score_after = sus_update(0, score, opponent_score)
    if score_after >= 100 or score_after - score > 8.7:
        return 0
    else:
        return 6
    # END PROBLEM 12
