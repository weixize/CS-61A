...
def closer_city(lat, lon, city_a, city_b):
    ...
    """
    "*** YOUR CODE HERE ***"
    current_place = make_city('current_place', lat, lon)
    return get_name(city_a) if distance(current_place, city_a) <= distance(current_place, city_b) else get_name(city_b)
